...
extern PyObject* client_inactivity_kick_handler;
extern PyObject* client_inactivity_kick_warning_handler;
extern PyObject* player_items_toss_handler;
...
int ClientInactivityKickDispatcher(int client_id);
