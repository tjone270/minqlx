...
PyObject* client_inactivity_kick_warning_handler = NULL;
...
static handler_t handlers[] = {
        ...
        {"player_inactivity_kick_warning", &client_inactivity_kick_warning_handler},
...
static PyObject* PyMinqlx_InitModule(void) {
    ...
    // Item indices
    PyModule_AddIntMacro(module, ITEM_ARMORSHARD);
    PyModule_AddIntMacro(module, ITEM_ARMORCOMBAT);
    PyModule_AddIntMacro(module, ITEM_ARMORBODY);
    PyModule_AddIntMacro(module, ITEM_ARMORJACKET);
    PyModule_AddIntMacro(module, ITEM_HEALTHSMALL);
    PyModule_AddIntMacro(module, ITEM_HEALTH);
    PyModule_AddIntMacro(module, ITEM_HEALTHLARGE);
    PyModule_AddIntMacro(module, ITEM_HEALTHMEGA);
    PyModule_AddIntMacro(module, ITEM_GAUNTLET);
    PyModule_AddIntMacro(module, ITEM_SHOTGUN);
    PyModule_AddIntMacro(module, ITEM_MACHINEGUN);
    PyModule_AddIntMacro(module, ITEM_GRENADELAUNCHER);
    PyModule_AddIntMacro(module, ITEM_ROCKETLAUNCHER);
    PyModule_AddIntMacro(module, ITEM_LIGHTNING);
    PyModule_AddIntMacro(module, ITEM_RAILGUN);
    PyModule_AddIntMacro(module, ITEM_PLASMAGUN);
    PyModule_AddIntMacro(module, ITEM_BFG10K);
    PyModule_AddIntMacro(module, ITEM_GRAPPLINGHOOK);
    PyModule_AddIntMacro(module, ITEM_SHELLS);
    PyModule_AddIntMacro(module, ITEM_BULLETS);
    PyModule_AddIntMacro(module, ITEM_GRENADES);
    PyModule_AddIntMacro(module, ITEM_CELLS);
    PyModule_AddIntMacro(module, ITEM_LIGHTNINGAMMO);
    PyModule_AddIntMacro(module, ITEM_ROCKETS);
    PyModule_AddIntMacro(module, ITEM_SLUGS);
    PyModule_AddIntMacro(module, ITEM_BFGAMMO);
    PyModule_AddIntMacro(module, ITEM_TELEPORTER);
    PyModule_AddIntMacro(module, ITEM_MEDKIT);
    PyModule_AddIntMacro(module, ITEM_QUAD);
    PyModule_AddIntMacro(module, ITEM_ENVIRONMENTSUIT);
    PyModule_AddIntMacro(module, ITEM_HASTE);
    PyModule_AddIntMacro(module, ITEM_INVISIBILITY);
    PyModule_AddIntMacro(module, ITEM_REGEN);
    PyModule_AddIntMacro(module, ITEM_FLIGHT);
    PyModule_AddIntMacro(module, ITEM_REDFLAG);
    PyModule_AddIntMacro(module, ITEM_BLUEFLAG);
    PyModule_AddIntMacro(module, ITEM_KAMIKAZE);
    PyModule_AddIntMacro(module, ITEM_PORTAL);
    PyModule_AddIntMacro(module, ITEM_INVULNERABILITY);
    PyModule_AddIntMacro(module, ITEM_NAILS);
    PyModule_AddIntMacro(module, ITEM_MINES);
    PyModule_AddIntMacro(module, ITEM_BELT);
    PyModule_AddIntMacro(module, ITEM_SCOUT);
    PyModule_AddIntMacro(module, ITEM_GUARD);
    PyModule_AddIntMacro(module, ITEM_DOUBLER);
    PyModule_AddIntMacro(module, ITEM_AMMOREGEN);
    PyModule_AddIntMacro(module, ITEM_NEUTRALFLAG);
    PyModule_AddIntMacro(module, ITEM_REDCUBE);
    PyModule_AddIntMacro(module, ITEM_BLUECUBE);
    PyModule_AddIntMacro(module, ITEM_NAILGUN);
    PyModule_AddIntMacro(module, ITEM_PROXLAUNCHER);
    PyModule_AddIntMacro(module, ITEM_CHAINGUN);
    PyModule_AddIntMacro(module, ITEM_SPAWNARMOR);
    PyModule_AddIntMacro(module, ITEM_HMG);
    PyModule_AddIntMacro(module, ITEM_HEAVYBULLETS);
    PyModule_AddIntMacro(module, ITEM_AMMOPACK);
    PyModule_AddIntMacro(module, ITEM_SILVERKEY);
    PyModule_AddIntMacro(module, ITEM_GOLDKEY);
    PyModule_AddIntMacro(module, ITEM_MASTERKEY);
